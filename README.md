...
- [`docs/design-considerations.md`](./docs/design-considerations.md) — 設計方針（言語、CLI、トランスポート層、各機能の選択論）
- [`docs/roadmap.md`](./docs/roadmap.md) — 実装順、依存関係、フェーズ分け、ブロッカー TODO
...
詳細な実装順とフェーズ分けは [`docs/roadmap.md`](./docs/roadmap.md)、設計上の選択論は [`docs/design-considerations.md`](./docs/design-considerations.md) を参照。
